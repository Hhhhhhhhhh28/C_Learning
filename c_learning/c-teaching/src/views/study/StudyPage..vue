  ...
  <div class="c-study-page">
    <div class="main-content">
      ...
      <div class="video-area">
        <video-player ref="videoRef" :options="playerOptions" class="vjs-custom-skin" @play="onVideoPlay" />
        <div class="info">
          <h3>主讲人：张老师</h3>
...
const questionList = reactive([
  {
    title: '题目 1：以下哪一个是 前端语言中的基本数据类型？',
    options: [
      { id: 'A', text: 'String' },
      { id: 'B', text: 'int' },
      { id: 'C', text: 'Array' },
    ...
    correctAnswer: 'B',
    explanation: '前端语言的基本数据类型包括 String、Number、Boolean 等。',
  },
  {
...
## 基本语法
前端语言的基本语法包括变量声明、函数定义、控制结构等。例如，变量声明可以使用以下语法：
\`\`\`javascript
let num;
\`\`\`

## 变量声明
在前端语言中，变量必须先声明后使用。声明变量时需要指定变量的类型和名称。例如：
\`\`\`javascript
let price;
\`\`\`
## 变量声明
